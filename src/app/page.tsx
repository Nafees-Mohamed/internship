...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col justify-between">
      ...
      {/* Hero Section */}
      <main className="flex-1 max-w-5xl mx-auto px-6 py-16 sm:py-24 text-center space-y-12">
        <div className="space-y-6">
          ...
          <p className="max-w-2xl mx-auto text-base sm:text-lg text-muted leading-relaxed">
            ...
            Allow participants to submit questions, play timed Rapid-Fire quizzes, earn points, get AI answer explanations, and climb the live leaderboard.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/hub?tab=challenge"
            className="w-full sm:w-auto rounded-xl bg-brand px-8 py-3.5 text-sm font-semibold text-white transition-all hover:bg-brand-strong shadow-md hover:shadow-lg text-center flex items-center justify-center gap-2"
          >
            <span>⚡ Start Rapid-Fire Challenge</span>
          </Link>
          <Link
            href="/hub?tab=qa"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 pt-8">
          ...
          {/* Card 2: Rapid-Fire Quiz */}
          <div className="rounded-2xl border border-brand/30 bg-brand-soft/20 p-6 text-left shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
            <div className="space-y-4">
              <div className="w-10 h-10 rounded-lg bg-brand flex items-center justify-center text-white text-lg font-bold">
                ⚡
              </div>
              <h3 className="text-lg font-bold text-foreground">Rapid-Fire Quiz</h3>
              <p className="text-sm text-muted leading-relaxed">
                Timed quiz mode! Answer questions before the countdown expires. Get instant points & Gemini AI answer explanations.
              </p>
            </div>
            <Link
              href="/hub?tab=challenge"
          ...
          <div className="rounded-2xl border border-warm/60 bg-surface p-6 text-left shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted leading-relaxed">
                Gamify your session by awarding 10 points for correct responses. Display real-time rankings of participants.
              </p>
            </div>
            <Link
